        ...
        <div className="max-w-screen-sm mx-auto">
          <p className="mb-10">
            ...
            <i className="mt-2">
              ...
              language and with that be able to get in touch with the best of my
              country: our people.
            </i>
          </p>
          <p className="mb-10">
            Espero que através desse projeto eu possa ajudar não só ela mas como
            você também que quer aprender o português e ter uma experiência
            única ao visitar o Brasil.
            <br />
            <i className="mt-2">
              I hope that through this project I can help not only her but also
              you, who wants to learn Portuguese and have a unique experience
          ...
          <p className="mb-10">
            ...
            <a href="mailto:vini.avena@poli.ufrj.br" className="underline">
              contactar
            </a>{' '}
